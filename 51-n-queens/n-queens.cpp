class Solution {
public:
    // bool canFill(vector<string> &curr,int row,int col,int n){
    //     int duprow = row;
    //     int dupcol = col;
    ...
    //     return true;
    // }
    // void back(vector<vector<string>> &ans,vector<string> &curr,int n,int col){
    //     if (col == n){
    //         ans.push_back(curr);
    //         return;
    //     }
    ...
    //         if (canFill(curr,row,col,n)){
    //             curr[row][col] = 'Q';
    //             back(ans,curr,n,col+1);
    //             curr[row][col] = '.';
    //         }
    //     }
    // }
